...
CopyPath:
           ...
           stz  LDFileCount           ; Zero out file count for this directory.
           stz  LDFileCount+1
...
; Save LDFileCount to it's place in the first block.

           lda  #<LDFileCount         ; Starting address
           sta  A1L
           lda  #>LDFileCount
           sta  A1H

           lda  #<LDFileCount+1        ; Ending address
           sta  A2L
           lda  #>LDFileCount+1
           sta  A2H
...
;
           ...
           lda  LDEntPerBlk           ; initialize file counter per block
           sta  EntLeft
...
;          Test for hit/miss and continue search
           ...
           lda  LDFileType            ; Filetype we're looking for.
...
Bottom:    .word   $0000
Top:       .word   $0000
AsciiTable: .byte "0123456789ABCDEF" ; Not sure if this should be asc or not
